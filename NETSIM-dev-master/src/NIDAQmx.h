...
int32 __CFUNC     DAQmxReadPowerF64              (TaskHandle taskHandle, int32 numSampsPerChan, float64 timeout, bool32 fillMode, float64 voltage[], float64 current[], uInt32 arraySizeInSamps, int32 *sampsPerChanRead, bool32 *reserved);
int32 __CFUNC     DAQmxReadPowerBinaryI16        (TaskHandle taskHandle, int32 numSampsPerChan, float64 timeout, bool32 fillMode, int16 voltage[], int16 current[], uInt32 arraySizeInSamps, int32 *sampsPerChanRead, bool32 *reserved);
