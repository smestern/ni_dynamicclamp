...
extern "C"
{
        ...
        int nidaqrec(void)
        {
                ...
                DAQmxSetSampTimingType(taskHandleWrite, DAQmx_Val_OnDemand); //In theory we could update this to a buffered output for better performance, but it would require more complex handling of the write buffer and timing. On-demand is simpler and should be sufficient for our use case.
        ...
        // ---- Test-suite helpers ----
        // Additive, side-effect-free accessors plus a state reset used by the
        // pytest suite. step_clamp is intentionally not touched.
        ...
        const char *get_ai_chan(void) { return aIChan; }
